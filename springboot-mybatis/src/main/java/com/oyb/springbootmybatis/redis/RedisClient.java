...
public class RedisClient {
     ...
     * @return
     */
    public List<String> lrange(final  String key, final long beginPrefix, final long endFix){

        return redisTemplete(key, new RedisExecute<List<String>>() {
            @Override
            public List<String>  doInvoker(Jedis jedis) {
               return jedis.lrange(key,beginPrefix,endFix);
            }
        });
